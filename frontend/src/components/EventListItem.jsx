...
const EventListItem = ({ event }) => {
  ...
  return (
    <>
        <Link href={`/events/${event.id}`} className="flex items-center justify-between rounded-b-lg border-b border-gray-200 p-4  hover:bg-gray-50 hover:transition-colors hover:shadow-md">
