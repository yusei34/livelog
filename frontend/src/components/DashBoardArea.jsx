    ...
    <>
      <div className="grid-cols-4">
        <div className="col-span-4 text-center space-y-2">
          <h2 className="text-3xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent flex items-center justify-center gap-3">
            <div className="p-2 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl text-white">
              <BarChart3 className="h-6 w-6" />
            </div>
            統計ダッシュボード
          </h2>
          <p className="text-gray-600">あなたの音楽活動を数字で振り返る</p>
        </div>
