      ...
      <div className="fixed inset-0 z-10 w-full overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4">
          <DialogPanel className="w-full max-w-lg p-6 bg-white rounded-2xl shadow-xl space-y-4">
            ...
            {/* 検索バーだけ表示し、選択時にhandleActorSelectを呼ぶ */}
            <SearchBar
            ...
            <div>
              {selectedIds.map((id, idx) => (
                <div
                  key={id}
                  className="rounded-lg p-4 bg-gradient-to-r from-orange-100 to-red-100 hover:from-orange-200 hover:to-red-200"
                >
                  <div className="flex justify-between">
                    <div className="text-xl pr-3">{selectedNames[idx]}</div>
                    <Button
            ...
            <div className="flex gap-2 mt-4">
              <Button
                ...
                className="px-4 py-2 text-white bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 shadow-lg rounded"
                type="button"
